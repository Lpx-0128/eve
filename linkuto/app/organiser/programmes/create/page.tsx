    ...
    <div className="max-w-3xl mx-auto space-y-8 pb-12">
      ...
      <div className="space-y-2">
        ...
        <p className="text-base text-text-muted font-body">
          Launch a new cohort and configure your participant application form.
        </p>
      </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                placeholder="Describe what this programme aims to achieve..."
                className="w-full px-5 py-4 rounded-xl border border-border-warm bg-bg-base focus:border-accent focus:ring-2 focus:ring-accent/20 outline-none transition-all font-body text-text-primary resize-none"
              />
            </div>

            <div className="space-y-2">
              <label className="text-xs font-bold text-text-primary uppercase tracking-wider">Industry Focus (comma separated)</label>
              <input
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <button 
                  type="button" onClick={addCustomQuestion}
              ...
              <div className="space-y-3">
                {customQuestions.map((q, idx) => (
                  <div key={q.id} className="flex gap-2">
                    <input
                      type="text" value={q.label} onChange={(e) => updateCustomQuestion(q.id, e.target.value)}
                      placeholder={`Question #${idx + 1}`}
                      className="flex-1 px-4 py-3 rounded-xl border border-border-warm bg-bg-base focus:border-accent outline-none transition-all text-sm font-body text-text-primary"
                    />
                    <button 
                      type="button" onClick={() => removeCustomQuestion(q.id)}
